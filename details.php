...
<!DOCTYPE html>
    ...
    <div style="padding-top: 64px;" class="grid-container">
        ...
        <div style="width:590px; height: 250px;" class="item2">
            <h3>Title: Amiakhum</h3>
            <h5>Location: Bandarbans</h5>
            <h5>Date: 21.02.2020</h5>
            <h4>Star Rating</h4>
        ...
        <div style="overflow-y: scroll; width:590px; height: 280px;" class="item3">
            ...
            <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical
                ...
                from the 1914 translation by H. Rackham Lorem Ipsum is simply dummy text of the printing and typesetting
